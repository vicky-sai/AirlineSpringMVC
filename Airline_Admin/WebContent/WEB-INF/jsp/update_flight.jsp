                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <form name="form1" action="update.do" method="post" class="col-lg-6">
                            	<table class="table table-bordered">
									  <tr>
		                                  <td>
		                                  <select type="number" class="form-control" name="airplane_id" required>
		                                    	<option value="----" selected disabled >Flight Id</option>
		                                    	<c:forEach items="${allFlightId}" var="fli">
									    			 <option value="${fli.flight_id}">${fli.flight_id}</option>
												</c:forEach>
												</select>
		                                  </td>
		                              </tr>		
		                              <tr>
		                                  <td><input type="text" class="form-control" placeholder="Airplane ID" name="airplane_id" required/> </td>
		                              </tr>
		                                <tr>
